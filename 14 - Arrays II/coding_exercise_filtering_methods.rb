...
def reverse_all(array_of_strings)
  reverse_array = array_of_strings.map { |word| word.reverse }
...
def words_with_letter(array_of_strings, letter)
  strings_with_letters = array_of_strings.select { |word| word.include?(letter) }
...
def evens_and_odds(numbers)
  even_numbers = numbers.partition { |number| number.even? }
